...
The visual character is grounded in California rivers and landscapes: warm pale surfaces, deep teal emphasis, restrained olive and gold context accents, and blue-grey water features. Use ample white space and clear hierarchy. In maps, project data may be more saturated than the basemap; in presentations, reserve stronger color for the central message, key numbers, and calls to action.
...
Favor an uncluttered, editorial layout with one clear idea per slide. Use the core UI palette as the default for presentation backgrounds, text, dividers, tables, and charts; reserve the project-type map palette for maps, legends, and project-category charts.
...
- For web, aim for WCAG 2.2 AA contrast and readability in digital materials; selected AAA criteria are encouraged for contrast, instructions, help, and cognitive accessibility.
