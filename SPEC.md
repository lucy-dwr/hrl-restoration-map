...
- **Prototype non-map equivalent status:** The current prototype includes a searchable/filterable Projects tab, list-driven selection, fit-to-visible-projects, zoom-to-project actions, and public data downloads. Automated WCAG A/AA regression checks cover representative states, and a thorough but non-exhaustive VoiceOver audit has been completed. Broader keyboard and assistive-technology review remains pending before accessibility is declared complete.
