...
export const PROJECT_ACRES_HELP =
  'Project acres may include aquatic, transitional, and terrestrial areas, so they may differ from the listed HRL aquatic habitat type acres or the mapped footprint.'
...
export const HRL_ACRES_HELP =
  'Total habitat acres across HRL aquatic habitat types. Unlike project acres, this total does not include other project areas, such as terrestrial habitat.'
